...
async def cb_handler(client, query: CallbackQuery):
    ...
    try:
        if data == "home":
            ...
            # SIMPLE FIX: Get format template and pass it safely
            try:
            ...
            # FIXED: Use string replacement instead of .format() to avoid KeyError
            # This preserves your original Txt.FILE_NAME_TXT explanation
            message_text = Txt.FILE_NAME_TXT.replace("{format_template}", format_template)
