...
🆓 **Free Users:** {free_limit} files per day
🌟 **Premium Users:** Unlimited files""".format(free_limit=Config.FREE_USER_DAILY_LIMIT)
...
**Yearly Plan:** ${Config.PREMIUM_YEARLY_PRICE}/year (Save 17%!)
...
**Free Users:**
• Daily limit: {Config.FREE_USER_DAILY_LIMIT} files
